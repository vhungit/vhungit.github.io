System.register("chunks:///_virtual/GameMgr.ts",["./_rollupPluginModLoBabelHelpers.js","cc","./Input.ts"],(function(t){"use strict";var n,e,r,o,a,i,c,s;return{setters:[function(t){n=t.inheritsLoose,e=t.defineProperty,r=t.assertThisInitialized},function(t){o=t.cclegacy,a=t._decorator,i=t.Quat,c=t.Component},function(t){s=t.Input}],execute:function(){var u;o._RF.push({},"ba7b0kbqfJLdYQzftkpTGSQ","GameMgr",void 0);var p=a.ccclass;a.property,t("GameMgr",p("GameMgr")(u=function(t){function o(){for(var n,o=arguments.length,a=new Array(o),c=0;c<o;c++)a[c]=arguments[c];return n=t.call.apply(t,[this].concat(a))||this,e(r(n),"rotation",new i),n}n(o,t);var a=o.prototype;return a.start=function(){this.rotation=this.node.rotation},a.update=function(t){console.log(s.Delta)},o}(c))||u);o._RF.pop()}}}));
...
System.register("chunks:///_virtual/main",["./Input.ts","./GameMgr.ts","./Rotation.ts"],(function(){"use strict";return{setters:[null,null,null],execute:function(){}}}));
